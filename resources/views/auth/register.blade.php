...
<div class="d-flex flex-row justify-content-center">
    <div class="d-flex col-lg-6 justify-content-center align-items-center" style="height: 100vh">
        <div class="d-flex align-items-center justify-content-center flex-column w-100">
            ...
            <form action="{{ route('register') }}" method="post" class="w-75">
                @csrf
                <div class="mb-3 mt-4">
                    <input type="name" class="form-control font-montserrat" id="name" name="name"
                ...
                <div class="mb-3 mt-4">
                    <input type="email" class="form-control font-montserrat" id="email" name="email"
                ...
                <div class="mb-3 mt-4">
                    <input type="password" class="form-control font-montserrat" id="password" name="password"
                ...
                <div class="mb-3 mt-4">
                    <input type="password" class="form-control font-montserrat" id="password_confirmation"
    ...
    <div class="d-flex d-none d-lg-flex col-6 justify-content-center align-items-center"
        style="height: 100vh; background-color: #F9F9F4;">
