            ...
            function(require, module, exports) {
                ...
                class r {
                    ...
                    add(t) {
                        ...
                        this.dt.hiddenHeader ?
                            ...
                            ((s.sortable = t.sortable),
                                s.setAttribute(
                                    "data-sortable", !0 === t.sortable ? "true" : "false"
                                )),
                            this.rebuild(),
                    ...
                    filter(t, e, s, i) {
                        const a = this.dt;
                        if (
                            (a.filterState || (a.filterState = { originalData: a.data }), !a.filterState[t])
                        ) {
                            const e = [...i, () => !0];
                ...
                class o {
                        ...
                        t.searchable &&
                            ((this.input = this.wrapper.querySelector(".dataTable-input")),
                                ...
                                this.input.addEventListener(
                                    "keyup",
                                    () => this.search(this.input.value), !1
                                )),
                    ...
                    page(t) {
                        return (
                            t != this.currentPage &&
                            (isNaN(t) || (this.currentPage = parseInt(t, 10)), !(t > this.pages.length || t < 0) &&
                                (this.render("page"),
                                    this.render("pager"),
                                ...
                                if ("txt" === o.type || "csv" === o.type) {
                                    for (h = "", n = 0; n < i.length; n++) {
                                        for (r = 0; r < i[n].cells.length; r++)
                                            if (!o.skipColumn.includes(s[r].originalCellIndex) &&
                                    ...
                                    for (
                                        h = `INSERT INTO \`${o.tableName}\` (`, n = 0; n < s.length; n++
                                    )
